...
:<<COMMENT
./run.generic.sh 1 24 $nodefile $nodes $explicitbind $procbind $verbose
./run.generic.sh 2 12 $nodefile $nodes $explicitbind $procbind $verbose
./run.generic.sh 3 8 $nodefile $nodes $explicitbind $procbind $verbose
